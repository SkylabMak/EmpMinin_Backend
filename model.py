...
xgb_modelEmp2 = joblib.load(curr_path + "/model/xgb_model_tomek2.joblib")
...
def predictEmp2(attributes: pd.DataFrame):
    try:
        print("att : ", attributes)
        ...
        # Use the model to make predictions
        predictions = xgb_modelEmp2.predict(new_data_processed)
